...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudMonitorQueryExpression) DeepCopyInto(out *CloudMonitorQueryExpression) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudMonitorQueryExpression.
func (in *CloudMonitorQueryExpression) DeepCopy() *CloudMonitorQueryExpression {
	if in == nil {
		return nil
	}
	out := new(CloudMonitorQueryExpression)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PredictionMetric) DeepCopyInto(out *PredictionMetric) {
	*out = *in
	if in.CloudMonitorSource != nil {
		in, out := &in.CloudMonitorSource, &out.CloudMonitorSource
		*out = new(CloudMonitorQueryExpression)
		(*in).DeepCopyInto(*out)
	}
	if in.PrometheusSource != nil {
		in, out := &in.PrometheusSource, &out.PrometheusSource
		*out = new(PrometheusQueryExpression)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrometheusQueryExpression) DeepCopyInto(out *PrometheusQueryExpression) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrometheusQueryExpression.
func (in *PrometheusQueryExpression) DeepCopy() *PrometheusQueryExpression {
	if in == nil {
		return nil
	}
	out := new(PrometheusQueryExpression)
...
func (in *TimeSeriesPredictionSpec) DeepCopyInto(out *TimeSeriesPredictionSpec) {
	*out = *in
	...
	out.PredictionCycle = in.PredictionCycle
	out.RefreshFrequency = in.RefreshFrequency
	return
}
