...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricPredictedData) DeepCopyInto(out *MetricPredictedData) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricPredictedData.
func (in *MetricPredictedData) DeepCopy() *MetricPredictedData {
	if in == nil {
		return nil
	}
	out := new(MetricPredictedData)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PredictionMetric) DeepCopyInto(out *PredictionMetric) {
	*out = *in
	if in.NodeResource != nil {
		in, out := &in.NodeResource, &out.NodeResource
		*out = new(NodeResource)
		**out = **in
	}
	if in.WorkloadResource != nil {
		in, out := &in.WorkloadResource, &out.WorkloadResource
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PredictionMetricConfiguration) DeepCopyInto(out *PredictionMetricConfiguration) {
	*out = *in
	if in.Resource != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PredictionMetricConfiguration.
func (in *PredictionMetricConfiguration) DeepCopy() *PredictionMetricConfiguration {
	if in == nil {
		return nil
	}
	out := new(PredictionMetricConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TimeSeriesPredictionSpec) DeepCopyInto(out *TimeSeriesPredictionSpec) {
	*out = *in
	...
	if in.PredictionMetricConfigurations != nil {
		in, out := &in.PredictionMetricConfigurations, &out.PredictionMetricConfigurations
		*out = make([]PredictionMetricConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TimeSeriesPredictionStatus) DeepCopyInto(out *TimeSeriesPredictionStatus) {
	*out = *in
	...
	if in.MetricPredictedDataList != nil {
		in, out := &in.MetricPredictedDataList, &out.MetricPredictedDataList
		*out = make([]*MetricPredictedData, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MetricPredictedData)
